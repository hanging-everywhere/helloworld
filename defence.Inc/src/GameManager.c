...
void GameManager_loadAllTextures(GameManager* gm) {
	gm->bgMapTexture1    = LoadTexture("assets/images/background(1).png");
	gm->bgMapTexture2    = LoadTexture("assets/images/background(2).png");
	gm->bgMapTexture3    = LoadTexture("assets/images/background(3).png");
	gm->skeletonTexture  = LoadTexture("assets/images/Skeleton.png");
	gm->slingTexture     = LoadTexture("assets/images/sling.png");
	gm->bonespearTexture = LoadTexture("assets/images/bonespear.png");
	// 13种塔贴图 [type索引 1-13]
	gm->towerTextures[1]  = LoadTexture("assets/images/sling.png");
	gm->towerTextures[2]  = LoadTexture("assets/images/bonespear.png");
	gm->towerTextures[3]  = LoadTexture("assets/images/totem.png");
	gm->towerTextures[4]  = LoadTexture("assets/images/fire.png");
	gm->towerTextures[5]  = LoadTexture("assets/images/crossbow.png");
	gm->towerTextures[6]  = LoadTexture("assets/images/mine.png");
	gm->towerTextures[7]  = LoadTexture("assets/images/cauldron.png");
	gm->towerTextures[8]  = LoadTexture("assets/images/firecrow.png");
	gm->towerTextures[9]  = LoadTexture("assets/images/pulse.png");
	gm->towerTextures[10] = LoadTexture("assets/images/gravity.png");
	gm->towerTextures[11] = LoadTexture("assets/images/portal.png");
	gm->towerTextures[12] = LoadTexture("assets/images/timeclock.png");
	gm->towerTextures[13] = LoadTexture("assets/images/laser.png");
}
...
void GameManager_processInput(GameManager* gm) {
	...
	gm->wood-=cw;gm->stone-=cs;gm->metal-=cm;gm->material-=cmat;
...
void GameManager_updateLogic(GameManager* gm, double dt) {
	...
	for(i=0;i<gm->enemyCount;){
		...
		if(gm->enemies[i].reachedBase||gm->enemies[i].hp<=0){
			if(gm->enemies[i].reachedBase){gm->base.hp--;gm->baseHealth=gm->base.hp;}
...
void GameManager_renderGraphics(GameManager* gm) {
	...
	/* 选塔提示 */
	/* 选塔提示 */
	static const char* selNames[]={"","[1]Sling","[2]BoneSpear","[3]Totem","[4]Fire","[5]Crossbow","[6]Mine","[7]Cauldron","[8]FireCrow","[9]Pulse","[0]Gravity","[Q]Portal","[E]TimeClock","[R]Laser"};
	DrawText(TextFormat("Selected:%s | Click tower to upgrade | [ESC]Cancel",selNames[gm->currentSelectedTower]),10,38,13,RAYWHITE);
